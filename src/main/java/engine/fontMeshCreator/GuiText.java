...
public class GuiText {
	...
	private final int FONT_SIZE_CONST = 58;
	 ...
	 */
	public GuiText(String text, FontType font, Vector2f scale, boolean centered) {
		this.textString = text;
		this.fontSize = scale.y*FONT_SIZE_CONST;
		this.font = font;
		this.scaleUp = new Vector2f(1 / scale.x, 1 / scale.y);
		this.lineMaxSize = scale.x*2;
